...
router.get('/',(req,res)=>{
    var query=`SELECT di.devicename,din.* FROM device_interfaces AS din INNER JOIN device_info AS di ON di.id=din.device_id where din.delete_flag='N'`;
...
router.post('/', (req, res) => {
    ...
    const query = "INSERT INTO  device_interfaces SET ?";
...
router.put('/:id',(req,res)=>{
    ...
    var id = req.params.id;
    var values = req.body;
    var query = "UPDATE device_interfaces SET ? WHERE id = ? ";
...
router.delete('/:id',(req,res)=>{
    ...
    var query = "UPDATE device_interfaces SET delete_flag='Y' WHERE id = ? ";
